<div id="page-wrapper"><div id="page">
  ...
  <div id="main-wrapper" class="clearfix"><div id="main" class="container">
	...
	<?php if ($breadcrumb && $page['banner_area']): ?>
	  <div id="breadcrumb"><?php print $breadcrumb; ?></div>
	<?php endif; ?>
	...
	<div class="row">
      ...
      <?php if ($page['sidebar_first']): ?>
        <div id="sidebar-first" class="col-sm-3 sidebar"><div class="sidebar-inner">
          <?php print render($page['sidebar_first']); ?>
        </div></div> <!-- /.sidebar-inner, /#sidebar-first -->
      <?php endif; ?>

      <div id="content"<?php print $content_col_class; ?>><div class="content-inner">
      ...
      <?php if ($page['sidebar_second']): ?>
        <div id="sidebar-second" class="col-sm-3 sidebar"><div class="sidebar-inner">
          <?php print render($page['sidebar_second']); ?>
        </div></div> <!-- /.sidebar-inner, /#sidebar-second -->
      <?php endif; ?>
